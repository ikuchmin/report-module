 ...
 */
public class IsuiPlanReportToOutputStream<T extends SourceFututeHSSFWorkBookReport & DestinationOutputStreamReport & ServiceIdReport> implements ReportFactory<T, Void> {
    private final String PATH_TO_REPORT = "/reports/juniprint/isui/isui_report_plan.xlt";
    @Inject
    ...
    public Function<T, Void> getRunner() {
        return (r) -> new ReportBuilder<>(r)
                ...
                .transform(HSSFWorkbookTransformers::fromOptionIncidentToReportPlan)
