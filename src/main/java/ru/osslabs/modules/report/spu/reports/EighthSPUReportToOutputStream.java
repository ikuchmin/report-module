 ...
 */
public class EighthSPUReportToOutputStream<T extends SourceFututeHSSFWorkBookReport & DestinationOutputStreamReport & ServiceIdReport> implements ReportFactory<T, Void> {
    private final String PATH_TO_REPORT = "/reports/juniprint/spu_report_8.xlt";
    ...
    public Function<T, Void> getRunner() {
        return (r) -> new ReportBuilder<>(r)
                ...
                .transform(HSSFWorkbookTransformers::fromStreamServiceToEighthReport)
